...
#      Implements Common Functions: Random sampling, FPS sampling, Grid sampling
#
# ----------------------------------------------------------------------------------------------------------------------
#
#      YUWEI CAO  -  2020/10/20 16:31 PM
#
#
# -----------------------------------------------------------------------------
...
class FPSSampler(BaseSampler):
    ...
    def sample(self, pos, batch, **kwargs):
        ...
        if len(pos.shape) != 3:
            raise Value("This class is for dense data and expects the pos tensor tobe of dimension 2")
